...
class TypeSerializer {
        ...
        if (payload_item instanceof Command) {
            ...
            if (payload_item instanceof Promise) {
                const message =
                    ...
                    ' for payload item: ' +
                    payload_item
                throw new CustomError(message, 'HT_PROMISE')
            }
            throw Error(
                'Unsupported payload item type: ' +
                    (payload_item?.constructor?.name || typeof payload_item) +
    ...
    static serializeCommand(command) {
        ...
        buffer.writeUInt8(Type.HT_COMMAND, 0)
    ...
    static serializeString(string_value) {
        ...
        buffer.writeUInt8(Type.HT_STRING, 0)
    ...
    static serializeInt(int_value) {
        ...
        buffer.writeUInt8(Type.HT_INTEGER, 0)
    ...
    static serializeBool(bool_value) {
        ...
        buffer.writeUInt8(Type.HT_BOOLEAN, 0)
    ...
    static serializeFloat(float_value) {
        const buffer = Buffer.alloc(6)
        buffer.writeUInt8(Type.HT_FLOAT, 0)
        buffer.writeUInt8(4, 1)
    ...
    static serializeByte(byte_value) {
        const buffer = Buffer.alloc(3)
        buffer.writeUInt8(Type.HT_BYTE, 0)
        buffer.writeUInt8(1, 1)
    ...
    static serializeChar(char_value) {
        const buffer = Buffer.alloc(3)
        buffer.writeUInt8(Type.HT_CHAR, 0)
        buffer.writeUInt8(1, 1)
    ...
    static serializeLongLong(longlong_value) {
        ...
        buffer.writeUInt8(Type.HT_LONG_LONG, 0)
    ...
    static serializeDouble(double_value) {
        const buffer = Buffer.alloc(10)
        buffer.writeUInt8(Type.HT_DOUBLE, 0)
        buffer.writeUInt8(8, 1)
    ...
    static serializeULLong(ullong_value) {
        const buffer = Buffer.alloc(10)
        buffer.writeUInt8(Type.HT_UNSIGNED_LONG_LONG, 0)
        buffer.writeUInt8(8, 1)
    ...
    static serializeUInt(uint_value) {
        const buffer = Buffer.alloc(6)
        buffer.writeUInt8(Type.HT_UNSIGNED_INTEGER, 0)
        buffer.writeUInt8(4, 1)
    ...
    static serializeNull() {
        const buffer = Buffer.alloc(3)
        buffer.writeUInt8(Type.HT_NULL, 0)
        buffer.writeUInt8(1, 1)
    ...
    static serializeUndefined() {
        const buffer = Buffer.alloc(3)
        buffer.writeUInt8(Type.HT_UNDEFINED, 0)
        buffer.writeUInt8(1, 1)
        buffer.writeUInt8(0, 2)
        return buffer
    }
