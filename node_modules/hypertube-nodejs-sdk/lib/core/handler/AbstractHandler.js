...
class AbstractHandler {
    ...
    /**
     * @param {Command} command
     * @param {number} requiredParametersCount
     * @param {string} callerName
     */
    validate(command, requiredParametersCount, callerName) {
        if (!command?.payload || command.payload.length < requiredParametersCount) {
            throw new Error(`${callerName} parameters mismatch`)
        }
    }
