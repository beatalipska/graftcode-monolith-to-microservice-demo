...
var RuntimeBridge_exports = {};
__export(RuntimeBridge_exports, {
...
module.exports = __toCommonJS(RuntimeBridge_exports);
...
class RuntimeBridge {
  ...
  static setWorkingDirectory(path) {
    import_UtilsConst.UtilsConst.setWorkingDirectory(path);
  }
  /**
