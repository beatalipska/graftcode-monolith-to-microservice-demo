 ...
 * This can be either the local currently running process (inMemory) or a particular remote process identified by the IP Address and PORT of the target instance.
 ...
 * @see [Hypertube Guides]{@link https://www.hypertube.dev/guides/v2/javascript/foundations/runtime-context}
 * @class
 */
export class RuntimeContext {
    ...
    /**
     * Adds a reference to a library. Hypertube allows you to reference and use modules or packages written in various languages.
     ...
     * @see [Hypertube Guides](https://www.hypertube.dev/guides/v2/javascript/getting-started/adding-references-to-libraries)
     * @method
     */
     ...
     * @see [Hypertube Guides](https://www.hypertube.dev/guides/v2/javascript/casting/casting)
     * @method
     */
     ...
     * @see [Hypertube Guides](https://www.hypertube.dev/guides/v2/javascript/methods-arguments/passing-arguments-by-reference-with-out-keyword |Passing Arguments by Reference with 'out' Keyword Guide)
     * @method
     */
     ...
     * @see [Hypertube Guides](https://www.hypertube.dev/guides/v2/javascript/fields-and-properties/getting-values-for-global-fields)
     * @method
     */
     ...
     * @see [Invoking Functions Guide](https://www.hypertube.dev/guides/v2/csharp/functions/invoking-functions)
     * @method
     */
