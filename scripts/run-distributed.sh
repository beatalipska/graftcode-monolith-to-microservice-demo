...
GRAFT_CONFIG_VALUE="name=@graft/npm-architecture-evolution-pricing;modules=./modules;runtime=nodejs;host=ws://architecture_evolution_pricing_gateway:19090/ws"
...
docker run -d \
  ...
  -p "$APP_HOST_WS_PORT:$APP_HOST_WS_PORT" \
  -p "$APP_HOST_VISION_PORT:$APP_HOST_VISION_PORT" \
