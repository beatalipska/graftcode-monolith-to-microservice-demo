...
var import_PassByValueHandler = require("./PassByValueHandler.cjs");
const handlers = {
  ...
  [import_CommandType.CommandType.PassByValue]: new import_PassByValueHandler.PassByValueHandler()
};
class Handler {
  ...
  static parseCommand(response, runtimeName) {
    ...
    } else if (response instanceof import_Command.Command) {
