...
import { getDirname, getRequire, isBrowserRuntime, isNodejsRuntime } from '../utils/Runtime.js'
 ...
 * @see [Hypertube Guides](https://www.hypertube.dev/guides/v2/javascript/foundations/runtime-context)
 */
export class ConfigRuntimeFactory {
    ...
    #getRuntimeContext(runtime, configName = 'default') {
        ...
        try {
            UtilsConst.setWorkingDirectory(jsonResolver.getWorkingDirectory())
        } catch (e) {
